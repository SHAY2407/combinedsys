...
class Sabertooth:
    ...
    def __init__(self, tcp: str, context):
        self.tcp = tcp      # this is the tcp of the client to which the server will connect to.
    ...
    def _connect(self):     # This is a private method to connect to the open port of the client 
        self.str_socket = self.context.socket(zmq.PUB)      # Notice that here Subscriber-Publisher concept is used instead of REQ-REP
